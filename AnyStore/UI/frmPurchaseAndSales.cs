        ...
        {//Get the Values from PurchaseSales Form First
            ...
            using (TransactionScope scope = new TransactionScope())
            {
                ...
                for (int i = 0; i < transactionDT.Rows.Count; i++)
                {
                    ...
                    //Here Increase or Decrease Product Quaity Based on Purchase or Sales
                ...
                if (success == true)
                {
                   ...
                   /* printer.Title = "\r\n\r\n\r\n ANYSTORE PVT. LTD. \r\n\r\n";
                    printer.SubTitle = "Modern College, shivajinagar Pune 5 \r\n Phone: 7249789537 \r\n\r\n";
                   ...
                   */
                    MessageBox.Show("Transaction Completed Sucessfully, Please DO VISIT AGAIN!!!");
